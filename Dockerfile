...
RUN apt-get update && apt-get upgrade -y && apt-get install locales && locale-gen en_US.UTF-8 && apt-get clean
...
RUN curl -sL https://deb.nodesource.com/setup_8.x | sudo -E bash - && sudo apt-get install -y nodejs && apt-get clean
